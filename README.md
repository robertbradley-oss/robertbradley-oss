...
- **[Neatly](https://github.com/robertbradley-oss/neatly-releases):** A local Windows folder organizer with preview, reusable rules, and undo. [Download for Windows](https://github.com/robertbradley-oss/neatly-releases/releases/latest).
